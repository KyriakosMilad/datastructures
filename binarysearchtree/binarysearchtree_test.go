...
func TestBinarySearchTree_PreOrderTraversal(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []int{25, 36, 40, 48, 46, 38, 30, 28, 20, 22, 10, 12, 14, 5},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := bst.PreOrderTraversal(); !reflect.DeepEqual(got, tt.want) {
...
func TestBinarySearchTree_InOrderTraversal(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []int{48, 46, 40, 38, 36, 30, 28, 25, 22, 20, 14, 12, 10, 5},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := bst.InOrderTraversal(); !reflect.DeepEqual(got, tt.want) {
